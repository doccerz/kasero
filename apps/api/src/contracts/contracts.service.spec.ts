...
describe('ContractsService', () => {
    ...
    describe('void', () => {
        ...
        it('allows voiding a draft contract', async () => {
        ...
        it('throws BadRequestException when contract status is voided', async () => {
            const voidedContract = { ...draftContract, status: 'voided' };
            const mockDb = buildMockDb();
